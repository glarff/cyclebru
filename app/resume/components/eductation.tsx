        ...
        <div className="px-10 font-lora text-md">
            <ol className="relative border-l border-gray-200">                  
                <li className="mb-10 mt-6 ml-6">            
                    ...
                    <h3 className="flex items-center mb-1 text-lg font-semibold px-16">Oregon State University, online — Bachelor of Science - BS,
Computer Science</h3>
                ...
                <li className="mb-10 mt-6 ml-6">            
                    ...
                    <h3 className="flex items-center mb-1 text-lg font-semibold px-16">University of Florida, Gainesville FL — Bachelor of Science -
BS, Industrial and Systems Engineering</h3>
